        ...
        <div>
            ...
            <ul class="space-y-6">
                <li class="flex gap-4">
                    ...
                    <span class="text-gray-500 text-sm">Plot No. 12/2, Nyerere Road,<br>Dar es Salaam, Tanzania</span>
                </li>
                <li class="flex gap-4">
                    <span class="material-symbols-outlined text-primary">call</span>
                    <span class="text-gray-500 text-sm">+255 22 2137773<br>+255 22 2133297</span>
                </li>
                <li class="flex gap-4">
